...
class StrayScanner(BaseScanner):
    def __init__(
        self,
        roots: Iterable[Path],
        ...
        self.skip_dirs = list(skip_dirs)
        super().__init__()

    def scan(self) -> Iterator[ModelEntry]:
        """Yield stray ModelEntry results found under any of self.roots.
